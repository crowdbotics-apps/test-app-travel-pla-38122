...
## Project Structure
    ...
    ├── test_app_travel_pla_38122  # Django project configurations
...
1. Clone this repo and `cd test_app_travel_pla_38122`
...
2. Clone this repo and `cd test_app_travel_pla_38122`
